...
export const KNOWN_LIMITATIONS: string[] = [
  ...
  'Wind output is projected using a cubic speed approximation (P ∝ v³ below rated speed, capped at 4× baseline). The analysis engine is aligned to the VC wind-fleet cut-in of 2.5 m/s. Near-rated or above-rated speeds may still be overestimated. Zero or below-cut-in baseline cases return null output with a limitation note.',
